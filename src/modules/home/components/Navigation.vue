    ...
    <div class="max-w-7xl mx-auto px-6">
      <div class="flex justify-between h-16 items-center">
        <div class="flex items-center gap-2 group cursor-pointer">
          ...
          <span class="font-medium text-sm tracking-tight text-zinc-900 dark:text-zinc-400 group-hover:text-emerald-600 transition-colors">emana.me</span>
        </div> 
        ...
        <div class="flex items-center gap-2 md:gap-3">
          ...
          <button
            @click="toggle"
            class="hidden lg:flex px-4 py-2 rounded-xl border border-zinc-300 dark:border-none hover:border-zinc-400 transition-colors bg-white/80 hover:bg-green-200 dark:bg-[#1F2937] text-[12px] dark:text-green-300"
            >{{ isDark ? '🌞 Light' : '🌙 Dark' }}
          </button>

          <!-- System Online - hidden on mobile -->
          <div
            class="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full border border-emerald-500/20 bg-emerald-50/50 dark:bg-emerald-900 backdrop-blur-sm">
      ...
      <div 
        ...
        <div class="flex flex-col py-4 space-y-1">
          ...
          <button 
            ...
            class="text-center text-sm font-medium bg-zinc-900/90 dark:bg-[#1F2937] text-white dark:text-slate-400 px-4 py-2 rounded-md hover:bg-zinc-800 dark:hover:bg-[#374151] transition-all flex items-center justify-centerW gap-2">
            <span>Contact</span>
